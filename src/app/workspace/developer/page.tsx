...
export default function DeveloperCalculatorPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 h-[50vh] xl:h-full relative z-10 bg-transparent flex flex-col p-6 gap-6 overflow-y-auto no-scrollbar">
      ...
      <div className="w-full xl:w-[350px] h-[20vh] xl:h-full shrink-0 z-20 border-t xl:border-t-0 xl:border-l border-border-default bg-surface/30 backdrop-blur-md">
        <ConversionPanel />
      </div>
    </motion.div>
  );
